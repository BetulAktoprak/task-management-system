        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 text-white w-full">
          ...
          <div className="flex flex-col gap-6 max-w-md">
            <h1 className="font-serif text-4xl xl:text-5xl font-bold leading-tight text-balance text-white">
              Platformunuza hoş geldiniz
            </h1>
            <p className="text-white/80 text-base leading-relaxed">
              Verilerinizi ve projelerinizi tek bir merkezden yönetin. Güvenli,
              hızlı ve modern bir deneyim sizi bekliyor.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-sm text-white/70">
              <span className="text-white font-medium">Güvenli</span> giriş ile
              verileriniz korunur
            </p>
          </div>
        </div>
